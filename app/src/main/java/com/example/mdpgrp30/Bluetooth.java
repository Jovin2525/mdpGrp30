    ...
    Runnable reconnectionRunnable = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                Toast.makeText(Bluetooth.this, "Failed to reconnect, trying in 5 second", Toast.LENGTH_SHORT).show();
            }
        }
    };
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)){
                ...
                if(mDevice.getBondState() == BluetoothDevice.BOND_BONDED){
                    ...
                    Toast.makeText(Bluetooth.this, "Successfully paired with " + mDevice.getName(), Toast.LENGTH_SHORT).show();
                    mBTDevice = mDevice;
                }
    ...
    private BroadcastReceiver mBroadcastReceiver5 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(status.equals("connected")){
                ...
                Toast.makeText(Bluetooth.this, "Device now connected to "+mDevice.getName(), Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Bluetooth.this, "Disconnected from "+mDevice.getName(), Toast.LENGTH_LONG).show();
                mBluetoothConnection = new BluetoothService(Bluetooth.this);
